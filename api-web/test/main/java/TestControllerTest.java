...
import com.api.service.method.MethodRuleService;
...
public class TestControllerTest {
    ...
    @Autowired
    private MethodRuleService methodRuleService;
...
//        methodRuleService.jyyMethodUpdate();
        methodRuleService.getPackageSupport();
//        methodRuleService.test();
        //daylyService.cacheDayFollow();
//        daylyService.cache60Breach();
    ...
    public void test1() {
        ...
        methodRuleService.test("002714", Calendar.MONDAY);

        System.out.println("============周二===============");
        methodRuleService.test("002714", Calendar.TUESDAY);

        System.out.println("============周三===============");
        methodRuleService.test("002714", Calendar.WEDNESDAY);

        System.out.println("============周四===============");
        methodRuleService.test("002714", Calendar.THURSDAY);

        System.out.println("============周五===============");
        methodRuleService.test("002714", Calendar.FRIDAY);
